...
Room.prototype.handleNukeAttack = function() {
  ...
  for (const nuke of nukes) {
    const structures = nuke.pos.findInRangePropertyFilter(FIND_MY_STRUCTURES, 4, 'structureType', [STRUCTURE_ROAD, STRUCTURE_RAMPART, STRUCTURE_WALL, STRUCTURE_EXTENSION], {inverse: true});
