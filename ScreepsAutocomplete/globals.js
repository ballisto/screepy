...
global.playerUsername = "Pantek59";
global.allies = ["Atavus","BlackLotus","Ashburnie","Tanjera","king_lispi","Moria","seancl","Atlan","Finndibaen","Klapaucius","ChaosDMG","Kenshi","Maxion","Trepidimous","Plasticbag","Lomewilwarin","joshua00214","vestad","andrwmorph","Baezon","Hachima","Calame","DoofenShmirtz","Atanner","Sheeo","Pundemonium","trebbettes","neomatrix"];
...
global.buildingPlans = {
    ...
    upgrader: [
        ...
        },
        {
            //Level 6 (max 2300)
            minEnergy: 2200,
            body: [MOVE, MOVE, MOVE, MOVE, MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY]
        },
        {
            //Level 7 (max 5600)
            minEnergy: 3200,
            body: [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY]
        },
        {
            //Level 8 (max 12900)
            minEnergy: 3250,
